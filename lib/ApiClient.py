...
class ApiClient:
    ...
    def get_intraday_data(self, symbol, month=None, interval='60min', outputsize='full'):
        return self.get_data('TIME_SERIES_INTRADAY', symbol, interval=interval, outputsize=outputsize, month=month)

    def get_sma(self, symbol, month=None, time_period=200, interval='60min', series_type='close'):
        return self.get_data('SMA', symbol, time_period=time_period, interval=interval, series_type=series_type, month=month)

    def get_macd(self, symbol, month=None, interval='60min', series_type='close'):
        return self.get_data('MACD', symbol, interval=interval, series_type=series_type, month=month)

    def get_rsi(self, symbol, month=None, time_period=200, interval='60min', series_type='close'):
        return self.get_data('RSI', symbol, time_period=time_period, interval=interval, series_type=series_type, month=month)
